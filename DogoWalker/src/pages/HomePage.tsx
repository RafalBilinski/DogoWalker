      ...
      <section className=" relative h-min-[500px] w-full flex-col items-center sm:px-3 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 h-full ">
          ...
          <div className=" flex justify-center mt-6 my:auto w-full p-3 rounded-2xl">
            <svg
              className="lg:hidden animate-bounce w-10 h-10 text-white text-shadow-black text-shadow-lg "
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <section className="py-10 ">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16">
            What Makes <span className="text-accent">Us</span> Different
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 transform transition-all hover:-translate-y-2 hover:shadow-xl">
              ...
              <p className="text-gray-600">
                Discover the best dog-friendly parks, trails, and walking routes in your
                neighborhood.
              </p>
            </div>
      ...
      <section className="relative py-20 ">
        ...
        <div className="z-40 container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Start Your Dog's Adventure?
          </h2>
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Join thousands of dog owners who've transformed their daily walks into social
            experiences.
          </p>
